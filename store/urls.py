...
urlpatterns = [
    ...
    path( 'create/new-order/<str:type>', ProductCreateView.as_view(),name='product-create'),
    ...
    #Designner 
    path("designer-order/<str:id>",views2.DesignDetailView.as_view(),name='designer-order'),
